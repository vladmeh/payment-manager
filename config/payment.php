...
return [
    ...
    'pscb' => [
         ...
         * String; maxlength: 2
         */
        'displayLang' => env('PSCB_DISPLAY_LANG', ''),
         ...
         * @var bool
         */
        'hold' => env('PSCB_HOLD', false),

        /*
         * Включает отображение отладочной информации в браузере
         * Плательщика в случае ошибок.
         * Используется в целях разработки.
         * Возможные значения: true, false (значение по умолчанию).
         *
         */
        'debug' => env('PSCB_DEBUG', false)
